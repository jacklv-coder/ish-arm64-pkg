...
| Swift manifest 真链接 | `test-swift-ios.sh --manifest-binary` | Stage1 Swift 与当前 `v0.4.0-abi.7` binary 链接 | `v0.4.0-abi.8` 修复已公开 |
