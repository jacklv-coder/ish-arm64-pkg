...
The Stage1 policy accepts only v0.4.0-abi.8 and publishes it as a prerelease.
...
ish_release_stage1_version_allowed "$VERSION" \
    || fail "Stage1 release policy allows only v0.4.0-abi.8; stable v0.4.0 requires Stage2"
