...
ish_release_stage1_version_allowed v0.4.0-abi.2 || {
    printf 'error: authorized Stage1 maintenance tag was rejected\n' >&2
    exit 1
}
for forbidden in v0.4.0 v0.4.0-abi.1 v0.4.0-abi.3 v0.4.0-rc.1 v1.2.3; do
