...
ish_release_stage1_version_allowed v0.4.0-abi.1 || {
    printf 'error: Stage1 transition tag was rejected\n' >&2
    exit 1
}
for forbidden in v0.4.0 v0.4.0-abi.2 v0.4.0-rc.1 v1.2.3; do
