...
# Stage1 is a single, deliberately named ABI-transition publication. Keeping
# this exact allowlist in executable policy prevents an accidental stable tag
# before Stage2 is integrated and separately authorized.
...
wire protocol v4. The public C ABI remains version 1. Swift source remains
v0.3.3-ABI compatible and does not call retain/release; the complete Swift
